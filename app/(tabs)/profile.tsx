...
export default function ProfileScreen() {
    ...
    async function fetchUserProfile() {
      ...
      try {
        ...
        if (profile) {
          ...
          console.warn("No se pudo cargar el perfil, usando modo offline");
        }
      } catch (error) {
  ...
  const {
    studentDetails: { career, currentSemester, gpa, controlNumber },
  } = userData;
  const fullName = capitalizeWords(
    `${userData.name} ${userData.paternalSurname} ${userData.maternalSurname}`
  );
    ...
    <View style={styles.screenContainer}>
      ...
      <View style={styles.header}>
        ...
        <ThemedText type="description">
          ID de Estudiante: {controlNumber}
        </ThemedText>
      ...
      <ThemedText type="title" style={styles.padding}>
